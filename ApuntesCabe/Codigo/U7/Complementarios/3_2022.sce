...
// Polinomios
[coefGrado1, err1] = min_cuadrados(x, y2022, funcGrado1);
[coefGrado2, err2] = min_cuadrados(x, y2022, funcGrado2);
[coefGrado3, err3] = min_cuadrados(x, y2022, funcGrado3);
