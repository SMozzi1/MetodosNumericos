...
// Calculo de raices de un polinomio cuadratico utilizando la resolvente.
...
// Calculo de raices de un polinomio cuadratico de manera robusta.
function raices = raices_robustas(p)
c = coeff(p,0);
b = coeff(p,1);
a = coeff(p,2);
